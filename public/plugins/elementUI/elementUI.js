		...
		t.default = {
			...
			methods: {
				...
				calcIconOffset: function(e) {
					var t = this.$el.querySelector(".el-input__" + e);
					if(t && t.parentNode === this.$el) {
						var i = {
							...
							n = i[e];
						this.$slots[n] ? t.style.transform = "translateX(" + ("suffix" === e ? "-" : "") + this.$el.querySelector(".el-input-group__" + n).offsetWidth + "px)" : t.removeAttribute("style")
					}
				},
